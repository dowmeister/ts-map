...
docker run --rm -v "%CD%\map_data\%GAME%:/data" tsmap-tippecanoe bash -c "tippecanoe -o /data/%GAME%.mbtiles -z8 -Z0 --drop-densest-as-needed --force -L roads:/data/geojson/roads.geojson -L prefab_roads:/data/geojson/prefab_roads.geojson -L prefab_flat:/data/geojson/prefab_flat.geojson -L prefab_buildings:/data/geojson/prefab_buildings.geojson -L map_flat:/data/geojson/map_flat.geojson -L map_buildings:/data/geojson/map_buildings.geojson -L ferries:/data/geojson/ferries.geojson -L cities:/data/geojson/cities.geojson -L companies:/data/geojson/companies.geojson -L overlays:/data/geojson/overlays.geojson"
